          ...
          <div className="container">
            <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap'}}>
              ...
              <nav className="nav-desktop" style={{display: 'flex', gap: '16px'}}>
                ...
                <a href="/preferences" style={{color: 'white', textDecoration: 'none', padding: '4px 8px', borderRadius: '4px', transition: 'background 0.2s'}}>Preferences</a>
            ...
            <nav className="nav-mobile" style={{display: 'none', justifyContent: 'space-around', marginTop: '8px', borderTop: '1px solid rgba(255,255,255,0.2)', paddingTop: '8px'}}>
              ...
              <a href="/preferences" style={{color: 'white', textDecoration: 'none', fontSize: '12px', textAlign: 'center', flex: 1}}>⚙️<br/>Preferences</a>
